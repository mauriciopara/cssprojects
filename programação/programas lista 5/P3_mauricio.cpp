//Olá Rodrigo, infelizmente não consegui realizar o trabalho por completo. Fiz o possível desmembrando a segunda função. No entanto há algum problema.
#include<iostream>
#include<conio.h>
using namespace std;

int quantidadeDeDigitosDeUmInteiro(int n) //função
{
 int i, r = 0;
 if (n == 0) return 1; 
 else while (n != 0)
